...
<title>View Cases — LegalAid</title>
...
<div class="app">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="active" title="View Cases">
    ...
    <main class="main">
        ...
        <section class="page-header">
            ...
            <p>
                ...
                View and monitor all cases across the platform.
...
ON cases.client_id=client.user_id

JOIN lawyer_profiles

ON cases.lawyer_id=lawyer_profiles.lawyer_id

JOIN users AS lawyer

ON lawyer_profiles.user_id=lawyer.user_id
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="case-title">
                                ...
                                <?php echo htmlspecialchars($row["case_title"]); ?>
                        ...
                        <td>
                            ...
                            <span class="description">
                                ...
                                <?php echo htmlspecialchars($row["case_description"]); ?>
                        ...
                        <td colspan="7">
                            ...
                            <div class="empty-state">
                                ...
                                <p>
                                    ...
                                    There are currently no cases to display.
