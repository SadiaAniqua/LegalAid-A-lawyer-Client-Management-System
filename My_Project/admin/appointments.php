...
<title>View Appointments — LegalAid</title>
...
<div class="app">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="active" title="View Appointments">
    ...
    <main class="main">
        ...
        <section class="page-header">
            ...
            <p>
                ...
                View and monitor all client appointments across the platform.
...
ON appointments.client_id=client.user_id
