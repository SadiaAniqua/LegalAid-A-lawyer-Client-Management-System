...
<title>Lawyer Verification — LegalAid</title>
...
<div class="app">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="active" title="Lawyer Verification">
    ...
    <main class="main">
        ...
        <section class="page-header">
            ...
            <p>
                ...
                Review and verify lawyers waiting for approval.
                        ...
                        <td>
                            ...
                            <div class="actions">
                                ...
                                <a
                                    ...
                                    href="verification.php?verify=<?php echo $row["lawyer_id"]; ?>"
                                ...
                                <a
                                    ...
                                    href="verification.php?reject=<?php echo $row["lawyer_id"]; ?>"
                        ...
                        <td colspan="7">
                            ...
                            <div class="empty-state">
                                ...
                                <p>
                                    ...
                                    There are currently no lawyers waiting for verification.
