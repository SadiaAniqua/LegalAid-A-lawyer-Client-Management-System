...
if(isset($_POST["report"]))
{
    ...
    if(empty($reported_user) || empty($appointment_id) || empty($description))
    {
    ...
    else
    {
        $sql = "INSERT INTO reports
                (reported_by, reported_user, appointment_id, reason, description, status)
                VALUES
                ('$client_id', '$reported_user', '$appointment_id',
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option value="<?php echo htmlspecialchars($row["appointment_id"]); ?>">
